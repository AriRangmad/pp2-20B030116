...
class Enemy(pygame.sprite.Sprite):
      def __init__(self): #инициализация экземпляров класса после их создания
        super().__init__() 
        self.image = pygame.image.load("racer/Enemy.png")
        self.surf = pygame.Surface((42, 70))
        self.rect = self.surf.get_rect(center = (random.randint(40,w-40), 0)) #создаем квадрат для удара
      def move(self):
